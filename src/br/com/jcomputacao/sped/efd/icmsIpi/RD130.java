  ...
  */
    ...
    */
    ...
    public RD130() {
        ...
        addFieldArchetype(COD_MUN_ORIG, cod);
        addFieldArchetype(COD_MUN_DEST, cod);
        addFieldArchetype(VEIC_ID, new FieldStringMaximumLengthArchetype(7));
        addFieldArchetype(VL_LIQ_FRT, cod);
        addFieldArchetype(VL_SEC_CAT, cod);
        addFieldArchetype(VL_DESP, cod);
        addFieldArchetype(VL_PEDG, cod);
        addFieldArchetype(VL_OUT, cod);
        addFieldArchetype(VL_FRT, cod);
