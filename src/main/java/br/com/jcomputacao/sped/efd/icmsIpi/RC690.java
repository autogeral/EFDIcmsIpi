...
public class RC690 extends LineArchetype {
  ...
  */
  ...
  /*
  * 2 - Código Fiscal de Operação e Prestação, conforme a tabela indicada no item 4.2.2
  ...
  */
   public static final String   VL_ICMS  = " VL_ICMS"; 
    ...
    /*
  * 8 -  Valor não tributado em função da redução da base de cálculo do ICMS, referente à combinação de CST_ICMS, CFOP e alíquota do ICMS.
  */
   public static final String VL_RED_BC   = "VL_RED_BC"; 
    ...
    /*
  * 9 -  Valor da base de cálculo do ICMS substituição tributária
  ...
  */
   public static final String VL_BC_ICMS_ST   = "VL_BC_ICMS_ST"; 
    ...
    /*
  * 10 - Valor do ICMS retido por substituição tributária
  */
  ...
  */
    ...
    public RC690() {
        setName("REGISTRO C690: REGISTRO ANALITICO DOS DOCUMENTOS (NOTAS FISCAIS/CONTAS DE ENERGIA ELETRICA (CODIGO 06), NOTA FISCAL/CONTA DE FORNECIMENTO D?AGUA CANALIZADA (CODIGO 29) E NOTA FISCAL/CONTA DE FORNECIMENTO DE GÁS (CODIGO 28) ");
        setDelimiter("|");
