...
public class RE250 extends LineArchetype{
    ...
    public static final String COD_OR = "COD_OR";
     ...
     /*
      * 3 -  Valor da obrigação ICMS ST a recolher
      */
    ...
    public static final String  DT_VCTO = " DT_VCTO";
     ...
     /*
      * 5 -    Código de receita referente à obrigação, próprio da unidade da federação do contribuinte substituído.
    ...
    public static final String  NUM_PROC = " NUM_PROC";
     ...
     /*
      * 7 -   Indicador da origem do processo: 0- SEFAZ; 1- Justiça Federal; 2- Justiça Estadual; 9- Outros
    ...
    public static final String  TXT_COMPL = " TXT_COMPL";
     ...
     /*
      *  10 -   Descrição complementar das obrigações a recolher 
